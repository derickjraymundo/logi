...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Route from Location A to B</h1>
                </div>
            </div>
        </div>
    </section>
...
var startLat = parseFloat("<?php echo isset($from_long) ? $from_long : '0'; ?>");
var startLong = parseFloat("<?php echo isset($from_lat) ? $from_lat : '0'; ?>");
