...
<div class="modal fade mdl_1" id="mdl_1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="frm_1" class="frm_1" action="setup_vendor_act.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="text_2">Vendor Name</label>
                        <input type="text" name="text_2" id="text_2" class="form-control capitalizeAllLetters">
                    </div>

                    <div class="form-group">
                        <label for="text_3">Vendor Type</label>
                        <select name="text_3" id="text_3" class="form-control">
                            <option value="">Select Vendor Type</option>
                            <?php
                            $vendorTypesQuery = $conn->query("SELECT id, vendor_type_name FROM tbl_setup_vendor_type WHERE isDeleted = 0");
                            while ($row = $vendorTypesQuery->fetch(PDO::FETCH_ASSOC)) {
                                echo "<option value='" . $row['id'] . "'>" . htmlspecialchars($row['vendor_type_name']) . "</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="text_5">Organization</label>
                        <input type="text" name="text_5" id="text_5" class="form-control capitalizeAllLetters">
                    </div>
...
$(document).on("click", ".edit_btn", function() {
        ...
        const itemVendorname = rowData.row2;
        const itemVendortype= rowData.row3;
        const itemVendororg= rowData.row4;
        const itemImage = rowData.row5; // Get item image URL


        // Populate the modal fields
        $('#text_1').val(itemId); 
        $('#text_2').val(itemVendorname); 
        $("#text_3").val(itemVendortype);
        $("#text_5").val(itemVendororg);
