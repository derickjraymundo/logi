            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Vehicle Parts</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<div class="modal fade mdl_1" id="mdl_1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="frm_1" class="frm_1" action="setup_vehicle_parts_act.php" method="POST" enctype="multipart/form-data">
...
<script>
  $(function(){ 
    ...
    'ajax': {
        'method': 'POST',
        'url': 'setup_vehicle_parts_act.php',
        'data': { tbl_1 },
    },
    'columns': [
