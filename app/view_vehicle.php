                ...
                <table class="table table-bordered" id="vehicleTable">
                    ...
                    <tbody>
                        ...
                        <tr class="vehicle-row">
                            ...
                            <td <?php echo ($remainingDays <= 30 && $remainingDays > 0) ? 'style="background-color: red; color: white;"' : ''; ?>>
                                <?php echo $remainingText; ?>
                            </td>
                            <td><?php echo $row['vehicle_type_name']; ?></td>
                            <td><?php echo $row['license_plate']; ?></td>
                            <td>
                                <a href="edit_vehicle.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                <button class="btn btn-danger btn-sm delete-vehicle" data-id="<?php echo $row['id']; ?>">Delete</button>
