...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Student's Account Management</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Student's Account Management</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<div class="modal fade mdl_1" id="mdl_1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="frm_1" class="frm_1" action="student_account_management_act.php" method="POST" enctype="multipart/form-data">
...
<script>
  $(function(){ 
    ...
    'ajax': {
        'method': 'POST',
        'url': 'student_account_management_act.php',
        'data': { tbl_1 },
    },
    'columns': [
                    ...
                    return `<div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu" style="">
                                    <a class="dropdown-item edit_btn" href="#">Edit</a>
                                     <a class="dropdown-item" href="fees_and_balance_view_students_id?ids=${row.row1}">Payments & Balances</a>
